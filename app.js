...
app.get("/players/", async (request, response) => {
  const getPlayerQuery = `
    SELECT
    player_id AS playerId,player_name AS playerName,jersey_number AS jerseyNumber,role AS role
    FROM
    cricket_team
    ORDER BY
    player_id;`;
...
app.get("/players/:playerId/", async (request, response) => {
  ...
  const convertDbObjectToResponseObject = (playerDetail) => {
    return {
